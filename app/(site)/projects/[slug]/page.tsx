...
export default function ProjectDetailPage({ params }: { params: { slug: string } }) {
  ...
  // Find related projects with same style (excluding current)
  const related = projects.filter((p) => p.style === project!.style && p.slug !== project!.slug).slice(0, 3);
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
      ...
      <div className="bg-neutral-100 dark:bg-neutral-800 p-6 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          ...
          <p className="text-neutral-700 dark:text-neutral-300">
            Contact us for a consultation or try the property finder to discover similar projects.
          </p>
        </div>
      ...
      {related.length > 0 && (
        <div>
          <h2 className="text-2xl font-semibold mb-4">Related {project!.style} Projects</h2>
